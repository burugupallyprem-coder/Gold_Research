"""
tests/parity_final.py
---------------------
Prove strategy.signals.decide_at == strategy.evaluate, bar-for-bar, including
the HTF warmup region. Capped 500-bar window keeps evaluate()'s pivot loop
fast; full HTF series is passed so the 4H EMA matches.

Run:  python tests/parity_final.py
"""
