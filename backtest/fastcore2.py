"""
backtest/fastcore2.py
---------------------
Event-driven backtester with verified mechanics (from backtest.core) and the
fast precomputed signal source (strategy.feat). This is the engine used for
real runs. tests/test_parity2.py proves the signal source matches evaluate().
"""
...
def run_backtest_fast(df, htf, strat_cfg=None, risk_cfg=None, bt_cfg=None, cost=None):
    ...
    cfg = {
        "engine": "fastcore2", "signal": "precomputed",
