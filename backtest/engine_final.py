"""
backtest/engine_final.py
------------------------
Production backtest engine: verified entry/exit/BE/cost mechanics (from
backtest.core) + the fast precomputed signal source (strategy.signals).
tests/parity_final.py proves the signal source equals strategy.evaluate().

run_backtest_fast(df, htf, strat_cfg, risk_cfg, bt_cfg, cost) -> BacktestResult
"""
