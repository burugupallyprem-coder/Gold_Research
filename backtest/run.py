...
backtest/run.py
---------------
Load cached OANDA candles, run the event-driven backtest, print metrics, and
write a trade blotter + summary to reports/.

Usage:
    python backtest/run.py
    python backtest/run.py --disp 1.4 --threshold 70 --no-gate --tag test
"""
